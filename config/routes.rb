Rails.application.routes.draw do
  namespace :api do
    namespace :v1 do
      ...
      get '/payments/getPaymentDetails/:store_id/:stock_id/:customer_id/:employee_id/:startDate/:endDate/:page/:per_page', to: 'payments#payment_details'
      ...
      get '/stores/getShop/:id', to: 'stores#show'
      put '/stores/updateShop/:id', to: 'stores#update'
